                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                       ...
                                       <td>
                                        ...
                                        <td><a href="actioncomplaintassign.php?comp_id=<?php echo $row['comp_id']; ?>&status=<?php echo $row['is_active']; ?>">Change</a></td>
                                       
                                        <td><a href="actionassigndeleteworker.php?comp_id=<?php echo $row['comp_id']; ?>">Delete</a></td>
                                    </tr>
                            <?php   }
                                }
                                else
